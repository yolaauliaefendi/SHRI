...
if (empty($_GET[datestart])) { 
  ...
  if (isset($_POST[filter])) {
    ...
    echo '<meta http-equiv="refresh" content="0;url=?actl=laporan_indikator_pri&actv=lin">';
    exit();
  }
...
?>
            <ol class="breadcrumb pull-right">
                ...
                <li class="breadcrumb-item active">Laporan Pelayanan Rawat Inap</li>
            </ol>

            <h1 class="page-header">Laporan Rawat Inap</h1>
                ...
                <div class="col-lg-12 ui-sortable">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
                        <div class="panel-heading ui-sortable-handle">
                            ...
                            <h4 style="color: inherit; font-size: 12px; line-height: 20px; margin-bottom: 0; margin-top: 0;">Laporan Pelayanan Rawat Inap</h4>
                        </div>
                                        ...
                                        <table id="data-table-default" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="1%" data-orderable="false">Tempat Tidur Terpakai (TT)</th>
                                                    ...
                                                    <th width="1%" data-orderable="false">Pasien Meninggal < 48 jam</th>
                                                    <th width="1%" data-orderable="false">Pasien Meninggal > 48 jam</th>
                                                    <th width="1%" data-orderable="false">Jumlah Pasien Keluar (Hidup + Meninggal)</th>
                                                    <th width="1%" data-orderable="false">Jumlah Lama Dirawat (LD)</th>
                                                    <th width="1%" data-orderable="false">Jumlah Hari Perawatan (HR)</th>
                                            ...
                                            $arrResultGdr = Array();
                                            $arrResultNdr = Array();
                                            $qbangsal = mysql_query("select a.IDRuangKelas, b.NamaRuangan, c.NamaKelas, a.Jml_TTPakai from tblruang_kelas a 
                ...
                <!-- <div class="col-lg-12 ui-sortable">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
                        <div class="panel-heading ui-sortable-handle">
                            ...
                            <h4 style="color: inherit; font-size: 12px; line-height: 20px; margin-bottom: 0; margin-top: 0;">Grafik Laporan Rawat Inap</h4>
                        </div>
