            <ol class="breadcrumb pull-right">
                ...
                <li class="breadcrumb-item active">Laporan Bangsal</li>
            </ol>

            <h1 class="page-header">Laporan Fasilitas Tempat Tidur</h1>
                ...
                <div class="col-lg-12 ui-sortable">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
                        <div class="panel-heading ui-sortable-handle">
                            ...
                            <h4 style="color: inherit; font-size: 12px; line-height: 20px; margin-bottom: 0; margin-top: 0;">Laporan Bangsal</h4>
                        </div>
